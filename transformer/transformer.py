...
This block of code joins all the layers together
"""
...
Loss is nothing but a prediction error of Neural Net. Loss function is used to compute how bad the model is doing at every of the training process.
"""
